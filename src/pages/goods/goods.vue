...
import { ServicePanal } from './components/servicePanal.vue'
import { AddressPanal } from './components/AddressPanal.vue'
...
<template>
  ...
  <!-- 显示⼀个按钮 -->
  <view @tap="openSkuPopup(SkuMode.Cart)" class="addcart"> 加⼊购物⻋ </view>
  <view @tap="openSkuPopup(SkuMode.Buy)" class="payment"> ⽴即购买 </view>
  <!-- 弹窗测试 -->
